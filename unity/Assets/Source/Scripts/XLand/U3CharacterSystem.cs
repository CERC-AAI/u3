...
#pragma warning restore 0162
    ...
    {
        _lastCustomInterpolationStartTime = mEngine.GetTime();
    ...
    {
        float interpolationFactor = Mathf.Clamp01((mEngine.GetTime() - _lastCustomInterpolationStartTime) / _lastCustomInterpolationDeltaTime);
